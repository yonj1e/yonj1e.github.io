...
![pg_basebackup-main](2018-08-29-pg_basebackup/pg_basebackup-main.jpg)
...
`ReceiveAndUnpackTarFile` 接收平面文件格式数据函数，获取表空间集合，根据目录递归的拷贝文件并写入本地。 
